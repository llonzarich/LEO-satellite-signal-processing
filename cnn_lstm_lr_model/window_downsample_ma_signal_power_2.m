...
% matlab -nodisplay -nosplash -nodesktop -r "run('/home/wairimu/leo-signal-proc/cnn_lstm_lr_model/window_downsample_ma_signal_power_2.m');exit;"
...
pattern_path1 = "/media/wairimu/Elements2/fc1075mhz_5sec/plots_done/have_pattern/signal_files";
pattern_path2 = "/media/wairimu/Elements2/fc1075mhz_5sec/plots_done/no_pattern/signal_files";
window_tensor_concat = 0;
labels_concat = 0;


dirlist = dir(pattern_path1);
...
for dir_ix = 1:length(dirlist)
    ...
    % path = "/media/wairimu/Elements2/ch1_usrp/no_pattern/gqrx_20250519_192317_1075059000_2400000_fc.raw";
    % [window_tensor, labels_vector] = window_downsample_ma_signal_power_fn(path);
...
save("/home/wairimu/window_tensor_concat_balanced_dataset.mat", "window_tensor_concat");
save("/home/wairimu/labels_concat_balanced_dataset.mat", "labels_concat");
