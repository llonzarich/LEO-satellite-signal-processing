...
path = "/media/wairimu/Elements2/ch1_community_forge/test_files";
...
for dir_ix = 1:length(dirlist)
    ...
    save(strcat("/home/wairimu/training_data_corrected_windowing/test_files/ch1_community_forge/segmented_test_signal_", file_id, ".mat"), "segmented_test_signal");
