...
% function preparing_cnn_matrix_1D_fn(path, tensor_fname, start_ix)
    ...
    [~, num_windows, window_samples, ~] = A3_window_signal(filepath);
    ...
    disp("size of 4D feature tensor:")
    disp(size(cnn_input))
    ...
    for i = start_ix:end_ix
        ...
        [~, has_pattern, ~, ~, ~] = A3_isolate_pattern(filepath);
        ...
        [~, num_windows, ~, iq_components] = A3_window_signal(filepath);
